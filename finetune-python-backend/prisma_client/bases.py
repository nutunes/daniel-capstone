...
class BaseSong(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Song']] = 'Song'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.SongActions[_PrismaModelT]':
        from .client import get_client

        return actions.SongActions[_PrismaModelT](client or get_client(), cls)
