...
SCHEMA_PATH = Path('/Users/dmpalmer/daniel-capstone/finetune-node-backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/dmpalmer/.npm/_npx/55ad0b431757dc30/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    song: 'actions.SongActions[models.Song]'
    ...
    def __init__(
        ...
        *,
        ...
        self.song = actions.SongActions[models.Song](self, models.Song)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/dmpalmer/daniel-capstone/finetune-node-backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.song = SongBatchActions(self)
